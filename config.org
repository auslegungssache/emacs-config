...
something simpler
* Completion
** TODO Consider adding https://github.com/muffinmad/emacs-mini-frame
** Recursive
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (leader-def
    "o d" (lambda () (interactive) (dired org-directory))
    "o n" (lambda () (interactive) (find-file org-default-notes-file))
    "o c" #'org-capture)
#+end_src
** Evil
#+begin_src emacs-lisp
