...
#+begin_src emacs-lisp
  (leaf all-the-icons-dired
    ...
    :straight t
    :require t
    :setq ((all-the-icons-dired-monochrome)))
#+end_src
*** Completion
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (leaf projectile
    ...
    :config
    (leader-def "p p" #'projectile-commander "p f" #'projectile-find-file "p s" #'projectile-switch-project)
